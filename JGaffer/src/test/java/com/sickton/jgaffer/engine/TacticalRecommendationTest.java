...
public class TacticalRecommendationTest {
    ...
    public void setUp() {
        ...
        livPlayingXI.put(ali, new PlayerState(ali, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(frimp, new PlayerState(frimp, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(kerk, new PlayerState(kerk, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(vvd, new PlayerState(vvd, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(kon, new PlayerState(kon, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(mac, new PlayerState(mac, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(sob, new PlayerState(sob, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(wirtz, new PlayerState(wirtz, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(hugo, new PlayerState(hugo, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(salah, new PlayerState(salah, InjuryStatus.NONE, StaminaLevel.HIGH));
        livPlayingXI.put(gakpo, new PlayerState(gakpo, InjuryStatus.NONE, StaminaLevel.HIGH));

        Map<Player, PlayerState> cityPlayingXI = new HashMap<Player, PlayerState>();
        cityPlayingXI.put(don, new PlayerState(don, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(ruben, new PlayerState(ruben, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(stones, new PlayerState(stones, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(nico, new PlayerState(nico, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(ait, new PlayerState(ait, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(rodri, new PlayerState(rodri, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(cherki, new PlayerState(cherki, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(reinj, new PlayerState(reinj, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(haaland, new PlayerState(haaland, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(jeremy, new PlayerState(jeremy, InjuryStatus.NONE, StaminaLevel.HIGH));
        cityPlayingXI.put(foden, new PlayerState(foden, InjuryStatus.NONE, StaminaLevel.HIGH));
